  ...
  return (
    <>
        <div className='fruits'>
           ...
           <FilterF lowtoHighHandler={lowtoHighHandler} hightoLowhHandler={hightoLowhHandler} searchHandler={searchHandler} />
           <div className="containerc">
                <div className="left-layout">
                    <Leftlayout />
                </div>
                <div className="fruits-rl">
                    <FruitsRl lowtoHighHandler={ltohfilteredData} hightoLowhHandler={htolfilteredData} searchItemData={searchItemData} />
                </div>
            </div>
        </div>
    </>
